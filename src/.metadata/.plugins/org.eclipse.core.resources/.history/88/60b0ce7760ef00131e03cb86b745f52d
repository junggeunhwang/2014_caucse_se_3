...
public class Main_view extends JFrame {
 	...
 	private void initialize_Menu()
	{
 	...
 	private JSplitPane initialize_VerticalSplitPane(){
		...
		splitPane_vertical.setDividerSize(0);			//splitPane ∞Ê∞Ëº± ≈©±‚ ¡ˆ¡§
 	...
 	private void initialize_HorizontalSplitPane(){
		...
		splitPane_horizontal.setDividerSize(12);			//splitPane ∞Ê∞Ëº± ≈©±‚ ¡ˆ¡§
		splitPane_horizontal.setDividerLocation(255);
		splitPane_horizontal.setContinuousLayout(true);	//∞Ê∞Ë ¿ÃµøΩ√ ±◊∏≤¿⁄ ¿Ãµø «ÿ¡¶
		splitPane_horizontal.setOneTouchExpandable(true);	//∫Æø° ∫Ÿ¿Ã±‚ ±‚¥… »∞º∫»≠
 	...
 	private JMenu buildFileMenu(){
		...
		mntmOpenDsm.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
		...
		mntmLoadClustering.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
		...
		mntmSaveClustering.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
		...
		mntmSaveClusteringAs.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
		...
		mntmExit.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
 	...
 	private JMenu buildViewMenu(){
		...
		mnView.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
				
		mntmRedraw = new JMenuItem("Redraw");
		mntmRedraw.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
		...
		mntmShow_Row_Labels.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
 	...
 	private JMenu buildHelpMenu(){
		...
		mnHelp.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
				
		mntmAbout = new JMenuItem("About...");
		mntmAbout.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F1, 0));
		mntmAbout.setMnemonic('A');
		mntmAbout.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 12));
	...
	public void drawTable(Vector<String> printElement)
	{
		...
		else
		{
			...
			for(int i=0; i<matrixSize; i++)
			{
					for(int j=1; j<=matrixSize; j++)
					{
						...
						{
							int dp=0;
							boolean from = ModelInfo.getInstance().getRoot().getNode(printElement.get(i)).isGroup(); //group¿Ã∏È true
		...
		dependency_table.setBackground(SystemColor.white);
		dependency_table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF); //¿⁄µø ∏ÆªÁ¿Ã¡Ó «ÿ¡¶
	...
	{
		scrollPane.removeAll();  // scrollPane¿« √ ±‚»≠
		classtree = new JTree(); // JTree¿« √ ±‚»≠
